...
<body>
	<%--
	Commons-FileUpliad를 이용하여 파일 업로드 및 정보 출력하기.
	Commons-FileUpliad 패키지를 사용하도록 page 디렉티브 태그의 import 속성 값에
	패키지 org.apache.commons.fileupload.*를 작성
	 ...
	 <%
		request.setCharacterEncoding("UTF-8");
	 	...
	 	// 업로드할 파일의 최대 크기, 메모리상에 저장할 최대 크기, 업로르된 파일을 임시로 저장할 경로를 작성.
	 	...
	 	if (item.isFormField()) {
	 		// 폼 페이지에서 전송된 요청 파라미터가 일반 데이터이면 요청 파라미터의 이름과 같은 값을 출력.
	 		...
	 		out.println("파일 콘텐츠 타임 : " + contentType + "<br>");
